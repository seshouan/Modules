...
print(f"{hero1.difference(hero2)}")
...
print(f"{hero2.difference(hero1)}")

# Attributes for hero1 or hero2 but not both (symmetric difference)
print("*"*30)
print("Symmetric Difference Set Operation")
print(f"{hero1.symmetric_difference(hero2)}")
print(f"{hero2.symmetric_difference(hero1)}")
