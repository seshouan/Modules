...
statement_one = f"Programmers: {full_name} is a {nationality} {profession} born in {birth_year}."
print(statement_one)
...
statement_three = f"In {year_of_publish} she published the first Algorithm, the {first_algorithm}, at the age of {year_of_publish - birth_year}."
