...
for idx, each_block in enumerate(new_chain.chain):
    print(f'Block {idx}')
    print(f'Hash: {each_block.hash_block()}')
    print(f'Prev Hash: {each_block.prev_hash}')
