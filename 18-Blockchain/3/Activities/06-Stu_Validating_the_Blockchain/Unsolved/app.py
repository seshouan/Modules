    ...
    def is_valid(self):
        ...
        for idx, block in enumerate(self.chain[1:]):
            ...
            if block_hash != block.prev_hash:
                ...
                print(f'block.prev_hash: {block.prev_hash}')
                print(f'block {idx} is invalid')
                return False
...
# Adds the cache_resource decorator for Streamlit
...
if st.button("Add Block"):
    ...
    st.text(f'Winning Hash {new_block.hash_block()}')
